const products = [
...

  {
    ...
    description: "Healthy Finger Millet Laddu",
    category: "Healthy Snacks",
    sizes: [
...

  {
    ...
    category: "Healthy Snacks",
    sizes: [
      { weight: "5 pcs", price: 25 },
      { weight: "10 pcs", price: 50 },
      { weight: "20 pcs", price: 100 },
    ],
  },

  {
    ...
    category: "Healthy Snacks",
    sizes: [
      { weight: "6 pcs", price: 60 },
      { weight: "12 pcs", price: 120 },
      { weight: "24 pcs", price: 240 },
    ],
  },
...
},
{
  ...
  name: "Kids 6 Days Healthy Snack Combo",
  image: "/images/6-Days-Combo-laddu.jpg",
  description: "Kids Special | 6 Days Healthy Snacks",
  sizes: [
    { weight: "1 Box", price: 179 },
  ],
},
{
  id: 12,
  category: "Combo Packs",
  name: "Women's Wellness 7 Days Combo",
  image: "/images/7-days-healthyladdu-combo.jpg",

  description: "Women's Special | 7 Days Healthy Combo",
  sizes: [
